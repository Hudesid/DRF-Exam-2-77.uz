...
class CustomUserManager(BaseUserManager):
    def _create_user(self, username=None, password=None, phone_number=None, **extra_fields):
        if username is None:
    ...
    def create_user(self, **extra_fields):
        ...
        return self._create_user(
            username=username, password=password, phone_number=phone_number, **extra_fields
        )
